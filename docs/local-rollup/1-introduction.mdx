...
a local Kubernetes cluster that uses the Astria shared sequencer network.
...
Specify the accounts that will be funded at the genesis block of your EVM rollup.
